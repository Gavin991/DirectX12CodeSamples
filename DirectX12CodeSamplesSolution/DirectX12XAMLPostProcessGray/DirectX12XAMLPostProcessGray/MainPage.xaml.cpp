...
using namespace DirectX12XAMLPostProcessGray;
...
void DirectX12XAMLPostProcessGray::MainPage::AroundOnClick(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
...
void DirectX12XAMLPostProcessGray::MainPage::HandleXChanged(Platform::Object^ sender, Windows::UI::Xaml::Controls::Primitives::RangeBaseValueChangedEventArgs^ e)
{
...
void DirectX12XAMLPostProcessGray::MainPage::HandleYChanged(Platform::Object^ sender, Windows::UI::Xaml::Controls::Primitives::RangeBaseValueChangedEventArgs^ e)
{
	float changed_x = (float)e->NewValue;
	if (m_windowVisible)
	{
...
void DirectX12XAMLPostProcessGray::MainPage::HandleZChanged(Platform::Object^ sender, Windows::UI::Xaml::Controls::Primitives::RangeBaseValueChangedEventArgs^ e)
{
	float changed_x = (float)e->NewValue;
	if (m_windowVisible)
	{
...
void DirectX12XAMLPostProcessGray::MainPage::OnDispatcherAcceleratorKeyActivated(Windows::UI::Core::CoreDispatcher^ sender, Windows::UI::Core::AcceleratorKeyEventArgs^ args)
{
	if (m_windowVisible)
	{
...
void DirectX12XAMLPostProcessGray::MainPage::ResetButton(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	if (m_windowVisible)
	{
		step = 0;
...
void DirectX12XAMLPostProcessGray::MainPage::MovieEnd(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	//mediaPlayer->Stop();
...
void DirectX12XAMLPostProcessGray::MainPage::CubeMapeOnClick(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
...
void DirectX12XAMLPostProcessGray::MainPage::NormalMapeOnClick(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
...
void DirectX12XAMLPostProcessGray::MainPage::ParallaxMapeOnClick(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
