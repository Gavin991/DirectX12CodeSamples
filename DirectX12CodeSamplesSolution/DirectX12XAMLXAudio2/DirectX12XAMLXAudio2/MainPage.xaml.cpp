...
void DirectX12XAMLXAudio2::MainPage::AroundOnClick(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
...
void DirectX12XAMLXAudio2::MainPage::HandleXChanged(Platform::Object^ sender, Windows::UI::Xaml::Controls::Primitives::RangeBaseValueChangedEventArgs^ e)
{
	float changed_x= (float)e->NewValue;
	if (m_windowVisible)
	{
		m_main->HandleLightPosChanged(0,changed_x);
	}	
}

void DirectX12XAMLXAudio2::MainPage::HandleYChanged(Platform::Object^ sender, Windows::UI::Xaml::Controls::Primitives::RangeBaseValueChangedEventArgs^ e)
{
	float changed_x = (float)e->NewValue;
	if (m_windowVisible)
	{
		m_main->HandleLightPosChanged(1,changed_x);
	}
}


void DirectX12XAMLXAudio2::MainPage::HandleZChanged(Platform::Object^ sender, Windows::UI::Xaml::Controls::Primitives::RangeBaseValueChangedEventArgs^ e)
{
	float changed_x = (float)e->NewValue;
	if (m_windowVisible)
	{
		m_main->HandleLightPosChanged(2,changed_x);
	}
}

void DirectX12XAMLXAudio2::MainPage::OnDispatcherAcceleratorKeyActivated(Windows::UI::Core::CoreDispatcher^ sender, Windows::UI::Core::AcceleratorKeyEventArgs^ args)
{
	if (m_windowVisible)
	{
...
void DirectX12XAMLXAudio2::MainPage::ResetButton(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	if (m_windowVisible)
	{
		step = 0;
...
void DirectX12XAMLXAudio2::MainPage::MovieEnd(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	//mediaPlayer->Stop();
...
void DirectX12XAMLXAudio2::MainPage::CubeMapeOnClick(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	m_main->CubeMappingEnable();
	soundPlayer->Play();
}


void DirectX12XAMLXAudio2::MainPage::NormalMapeOnClick(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	m_main->NormalMappingEnable();
	soundPlayer->Play();
}


void DirectX12XAMLXAudio2::MainPage::ParallaxMapeOnClick(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	m_main->ParallaxMappingEnable();
	soundPlayer->Play();
}


void DirectX12XAMLXAudio2::MainPage::MoveForward(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	m_main->HandleCubeMove(0);
}


void DirectX12XAMLXAudio2::MainPage::MoveLeft(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	m_main->HandleCubeMove(1);
}



void DirectX12XAMLXAudio2::MainPage::MoveRight(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	m_main->HandleCubeMove(2);
}


void DirectX12XAMLXAudio2::MainPage::MoveBackward(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	m_main->HandleCubeMove(3);
}


void DirectX12XAMLXAudio2::MainPage::VolumeChanged(Platform::Object^ sender, Windows::UI::Xaml::Controls::Primitives::RangeBaseValueChangedEventArgs^ e)
{
	float changed_x = (float)e->NewValue;
	if (m_windowVisible)
	{
		m_main->HandleLightPosChanged(3, changed_x);
	}
}
