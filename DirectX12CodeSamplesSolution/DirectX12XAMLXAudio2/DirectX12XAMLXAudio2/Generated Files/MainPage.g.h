...
namespace DirectX12XAMLXAudio2
{
    ...
    private:
        ...
        private: ::Windows::UI::Xaml::Controls::Button^ buttonforward;
        private: ::Windows::UI::Xaml::Controls::Button^ buttonbackward;
        private: ::Windows::UI::Xaml::Controls::Button^ buttonLeft;
        private: ::Windows::UI::Xaml::Controls::Button^ buttonRight;
