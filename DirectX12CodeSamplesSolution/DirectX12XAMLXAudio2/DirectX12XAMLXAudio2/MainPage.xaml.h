...
namespace DirectX12XAMLXAudio2
{
	...
	private:
		...
		void MoveLeft(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e);
		void MoveRight(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e);
		void MoveForward(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e);
		void MoveBackward(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e);
