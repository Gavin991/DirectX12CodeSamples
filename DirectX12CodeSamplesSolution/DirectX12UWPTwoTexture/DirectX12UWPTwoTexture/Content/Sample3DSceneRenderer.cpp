...
using namespace DirectX12UWPTwoTexture;
...
m_customSphere.UpdateVertexAndIndexSubresources();
		...
		// 为常量缓冲区创建描述符堆。
		{
			int custom_geometry_num = m_customSphere.GetSphereNumber();
  ...
  //      NAME_D3D12_OBJECT(m_constantBuffer);
		...
		//{			
		//	m_cbvHeapManager.CreateConstantBufferView(cbvGpuAddress, c_alignedConstantBufferSize);
		//}
