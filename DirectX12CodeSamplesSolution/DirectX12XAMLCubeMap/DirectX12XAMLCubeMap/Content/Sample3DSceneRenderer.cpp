...
bool Sample3DSceneRenderer::Render()
{
	...
	PIXBeginEvent(m_commandList.Get(), 0, L"Draw the cube");
	{
		...
		//使用第一张纹理，渲染第一个球体
		m_textureManager.BindTexture(&m_cbvHeapManager, L"Assets\\pic01.jpg", 3, m_commandList);
		...
		//使用第二张纹理，渲染第二个球体
		m_textureManager.BindTexture(&m_cbvHeapManager, L"Assets\\pic02.jpg", 3, m_commandList);
		offsetPos = { -1,0,0 };
