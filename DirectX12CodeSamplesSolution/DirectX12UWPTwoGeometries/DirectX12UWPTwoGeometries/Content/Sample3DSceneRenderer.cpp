...
using namespace DirectX12UWPTwoGeometries;
...
#pragma region 加载纹理部分
		...
		// 将纹理资源上载到GPU Upload the Shader Resource to the GPU.
		{
			...
			m_cbvHeapManager.CreateShaderResourceView(m_texture.Get(), textureDesc);
		}
#pragma endregion
...
#pragma region 像素着色器常量缓存 Pixel Shader Constant Buffer
		{
			...
			m_cbvHeapManager.CreateConstantBufferView(cbvGpuAddress, c_alignedConstantPSBufferSize);
