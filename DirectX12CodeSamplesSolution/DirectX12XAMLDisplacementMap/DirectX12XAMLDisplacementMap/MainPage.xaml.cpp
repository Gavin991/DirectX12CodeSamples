...
void DirectX12XAMLDisplacementMap::MainPage::AroundOnClick(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
...
void DirectX12XAMLDisplacementMap::MainPage::HandleXChanged(Platform::Object^ sender, Windows::UI::Xaml::Controls::Primitives::RangeBaseValueChangedEventArgs^ e)
{
...
void DirectX12XAMLDisplacementMap::MainPage::HandleYChanged(Platform::Object^ sender, Windows::UI::Xaml::Controls::Primitives::RangeBaseValueChangedEventArgs^ e)
{
	float changed_x = (float)e->NewValue;
	if (m_windowVisible)
	{
...
void DirectX12XAMLDisplacementMap::MainPage::HandleZChanged(Platform::Object^ sender, Windows::UI::Xaml::Controls::Primitives::RangeBaseValueChangedEventArgs^ e)
{
	float changed_x = (float)e->NewValue;
	if (m_windowVisible)
	{
...
void DirectX12XAMLDisplacementMap::MainPage::OnDispatcherAcceleratorKeyActivated(Windows::UI::Core::CoreDispatcher^ sender, Windows::UI::Core::AcceleratorKeyEventArgs^ args)
{
	if (m_windowVisible)
	{
...
void DirectX12XAMLDisplacementMap::MainPage::ResetButton(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	if (m_windowVisible)
	{
		step = 0;
...
void DirectX12XAMLDisplacementMap::MainPage::MovieEnd(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	//mediaPlayer->Stop();
...
void DirectX12XAMLDisplacementMap::MainPage::CubeMapeOnClick(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
...
void DirectX12XAMLDisplacementMap::MainPage::NormalMapeOnClick(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
...
void DirectX12XAMLDisplacementMap::MainPage::ParallaxMapeOnClick(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
