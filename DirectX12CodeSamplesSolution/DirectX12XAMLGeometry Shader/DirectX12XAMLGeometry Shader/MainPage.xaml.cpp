...
void DirectX12XAMLGeometry_Shader::MainPage::AroundOnClick(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
...
void DirectX12XAMLGeometry_Shader::MainPage::HandleXChanged(Platform::Object^ sender, Windows::UI::Xaml::Controls::Primitives::RangeBaseValueChangedEventArgs^ e)
{
...
void DirectX12XAMLGeometry_Shader::MainPage::OnDispatcherAcceleratorKeyActivated(Windows::UI::Core::CoreDispatcher^ sender, Windows::UI::Core::AcceleratorKeyEventArgs^ args)
{
	if (m_windowVisible)
	{
...
void DirectX12XAMLGeometry_Shader::MainPage::ResetButton(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	if (m_windowVisible)
	{
		step = 0;
...
void DirectX12XAMLGeometry_Shader::MainPage::MovieEnd(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	//mediaPlayer->Stop();
...
void DirectX12XAMLGeometry_Shader::MainPage::HandleExplodeChanged(Platform::Object^ sender, Windows::UI::Xaml::Controls::Primitives::RangeBaseValueChangedEventArgs^ e)
{
	float changed_x = (float)e->NewValue;
	if (m_windowVisible)
	{
		m_main->HandleExplodeChanged(changed_x);
	}
}
