	...
	void* pUserContext)
{
	...
	V_RETURN(DXUTFindDXSDKMediaFileCch(szShaderPath, MAX_PATH, L"AmbientEffect.fx"));
	...
	double fTime, float fElapsedTime, void* pUserContext)
{
	...
	float coler[4] = { 0.3f,0.3f,0.3f,1.0f };
