...
ID3DX11EffectVectorVariable*                   g_CameraPos;
ID3DX11EffectVectorVariable*                   g_Specular;
ID3DX11EffectScalarVariable*                   g_Power;
//--------------------------------------------------------------------------------------
	...
	void* pUserContext)
{
	...
	effect11_variable = g_pEffect->GetVariableByName("g_mView");
	g_pmWView = effect11_variable->AsMatrix();
	effect11_variable = g_pEffect->GetVariableByName("g_mProjection");
	...
	effect11_variable = g_pEffect->GetVariableByName("g_CameraPos");
	g_CameraPos = effect11_variable->AsVector();
	effect11_variable = g_pEffect->GetVariableByName("g_Specular");
	g_Specular = effect11_variable->AsVector();
	effect11_variable = g_pEffect->GetVariableByName("g_Power");
	...
	const DXGI_SURFACE_DESC* pBackBufferSurfaceDesc, void* pUserContext)
{
	...
	g_SimpleCamera.GetProjectionMatrix(&g_mProjection);
	g_SimpleCamera.SetViewParameters(XMFLOAT3(0.0f, 250.0f, -300.0f), XMFLOAT3(0.0f, 1.0f, 0.0f), XMFLOAT3(0.0f, 1.0f, 0.0f));
	//g_SimpleCamera.SetViewParameters(XMFLOAT3(0.0f, 3.0f, -6.0f), XMFLOAT3(0.0f, 1.0f, 0.0f), XMFLOAT3(0.0f, 1.0f, 0.0f));
	g_SimpleCamera.GetViewMatrix(&g_mWView);
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
	...
	InitApp();
	DXUTCreateWindow(L"DrectXEleven");
